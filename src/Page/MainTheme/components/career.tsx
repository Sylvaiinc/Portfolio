...
export default function Career() {
	return <div className="flex flex-col w-11/12 md:w-full">
		...
		<div className="flex flex-col w-full">
			...
			<div className="flex flex-col w-full pl-2">
				<ul className="list-outside pl-3.5 *:-indent-2.5">
					<li>- Conception & structuration BDD, architecture applicative</li>
					<li>- Refonte fonctionnelle complète (système d’iframes)</li>
					<li>- Livraison de nouvelles features en 2 mois (appli bloquée 1 an)</li>
					<li>- Maintenance & développement continu</li>
					<li>- Gestion serveurs OVH (config, sous-domaines, réseau simulé)</li>
					<li>- Collaboration avec dirigeant, équipe commerciale et actionnaires</li>
				</ul>
				<br/>
				<span>Tech: Symfony, React, React Native, Typescript, Pyhton kivy, MariaDb, Git</span>
			</div>
		</div>
		...
		<div className="flex flex-col w-full">
			...
			<div className="flex flex-col w-full pl-2">
				<ul className="list-outside pl-3.5 *:-indent-2.5">
					<li>- Conception d’un langage informatique descriptif propriétaire</li>
					<li>- Développement d’applications web & mobiles (prototype → prod)</li>
					<li>- Animation de réunions clients, suivi projet</li>
					<li>- Mise en place de tests (unitaires, E2E, non-régression)</li>
				</ul>
				<br/>
				<span>Tech: React, React Native, Typescript, ArangoDb, Git</span>
			</div>
		</div>
		<div className="divider"/>
		<div className="flex flex-col w-full">
			...
			<div className="flex flex-col w-full pl-2">
				<ul className="list-outside pl-3.5 *:-indent-2.5">
					<li>- Outils internes en JS/PHP pour automatiser les processus métiers</li>
					<li>- Maintenance et évolution continue des sites existants</li>
					<li>- Refonte et modernisation des anciens outils</li>
					<li>- Définition & supervision de l’architecture projet</li>
				</ul>
				<br/>
				<span>Tech: JavaScript, PHP, HTML/CSS, bases de données relationnelles, gestion d’architecture applicative.</span>
			</div>
		</div>
		<div className="divider"/>
		<div className="flex flex-col w-full">
			...
			<div className="flex flex-col w-full pl-2">
				<ul className="list-outside pl-3.5 *:-indent-2.5">
					<li>- Résolution tickets maintenance applicative</li>
					<li>- Développement d’évolutions selon besoins métiers</li>
				</ul>
				<br/>
				<span>Tech: JavaJEE, Javascript, MariaDB, Git</span>
			</div>
		</div>
		<div className="divider"/>
		<div className="flex flex-col w-full">
			...
			<div className="flex flex-col w-full pl-2">
				<ul className="list-outside pl-3.5 *:-indent-2.5">
					<li>- Maintenance & nouvelles fonctionnalités</li>
					<li>- Mise en place d’un projet Wordpress</li>
					<li>- Modification d’un thème Grav</li>
				</ul>
				<br/>
				<span>Tech: Symfony, Javascript, Twig, Docker, Git, Grav, Wordpress</span>
			</div>
		</div>
		<div className="divider"/>
		<div className="flex flex-col w-full">
			...
			<div className="flex flex-col w-full pl-2">
				<ul className="list-outside pl-3.5 *:-indent-2.5">
					<li>- Cahier des charges avec le client</li>
					<li>- Mise en place BDD, environnement, versionning</li>
					<li>- Développement & tests du site</li>
					<li>- Formation des professeurs</li>
				</ul>
				<br/>
				<span>Tech: Symfony 2.7, Twig, PHP, JavaScript, CSS, Git, GitLab, Trello.</span>
			</div>
		</div>
		<br/>
		<br/>
